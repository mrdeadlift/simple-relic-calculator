...
export const WEAPONS: Weapon[] = [
  ...
  },
  {
    ...
    description:
      "曲剣系の武器。盗賊の曲剣 (Bandit's Curved Sword)の特性を持つ。",
    obtainMethod: "フィールド獲得",
    weight: 3.5,
    characterCompatibility: {
      追跡者: 4,
  ...
  },
  {
    ...
    description:
      "曲剣系の武器。流水の曲剣 (Flowing Water Curved Sword)の特性を持つ。",
    obtainMethod: "フィールド獲得",
    weight: 3.5,
    characterCompatibility: {
      追跡者: 4,
  ...
  },
  {
    ...
    description:
      "曲剣系の武器。ノクスの流剣 (Nokx's Fluid Sword)の特性を持つ。",
    obtainMethod: "フィールド獲得",
    weight: 3.5,
    characterCompatibility: {
      追跡者: 4,
  ...
  },
  {
    ...
    description:
      "曲剣系の武器。穢れのシミター (Blighted Scimitar)の特性を持つ。",
    obtainMethod: "フィールド獲得",
    weight: 3.5,
    characterCompatibility: {
      追跡者: 4,
  ...
  },
  {
    ...
    description:
      "曲剣系の武器。蛇神の曲剣 (Serpent God's Curved Sword)の特性を持つ。",
    obtainMethod: "フィールド獲得",
    weight: 3.5,
    characterCompatibility: {
      追跡者: 4,
...
export const WEAPON_GROUPS = {
  melee: WEAPONS.filter(
    (w) => !["弓", "大弓", "クロスボウ", "杖", "聖印"].includes(w.type)
  ),
...
export const WEAPON_COUNT_BY_TYPE = Object.fromEntries(
  ALL_WEAPON_TYPES.map((type) => [
    type,
    WEAPONS.filter((w) => w.type === type).length,
  ])
);
